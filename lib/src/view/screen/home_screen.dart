...
import 'package:martfury/app/modules/blog/widgets/blog_post_slider.dart';
...
import 'package:martfury/app/modules/blog/bindings/blog_binding.dart';
...
import 'package:martfury/app/modules/blog/views/blog_view.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  /// Handles ad link navigation. If link is /products or domain/products,
  /// navigates to ProductScreen (Explore tab). Otherwise opens WebView.
  void _handleAdLinkTap(BuildContext context, String link, String title) {
    // Parse the link to check if it's a products page
              ...
              child: GestureDetector(
                onTap: () {
                  if (ads[0].link != null && ads[0].link!.isNotEmpty) {
                    _handleAdLinkTap(context, ads[0].link!, ads[0].name);
                  }
                },
                child: Image.network(
                  ads[0].image,
                  ...
                  child: GestureDetector(
                    onTap: () {
                      if (ads[i].link != null && ads[i].link!.isNotEmpty) {
                        _handleAdLinkTap(context, ads[i].link!, ads[i].name);
                      }
                    },
                    child: Container(
