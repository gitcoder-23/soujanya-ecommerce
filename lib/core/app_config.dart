...
class AppConfig {
  ...
  static String helpCenterUrl =
      dotenv.env['HELP_CENTER_URL'] ?? 'https://soujanya360.com/contact';
  static String customerSupportUrl =
      dotenv.env['CUSTOMER_SUPPORT_URL'] ?? 'https://soujanya360.com/contact';
  static String blogUrl =
      dotenv.env['BLOG_URL'] ?? 'https://soujanya360.com/blog';
