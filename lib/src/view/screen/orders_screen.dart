...
class _OrdersScreenState extends State<OrdersScreen> {
  ...
  Widget _buildFilterChips() {
    final filters = [
      ...
      {'key': 'canceled', 'label': 'orders.filter_canceled'.tr()},
    ];
    ...
    return PopupMenuButton<String>(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(Icons.sort, size: 20, color: AppColors.appBarForeground),
            const SizedBox(width: 4),
            Text(
              'orders.sort'.tr(),
              style: kAppTextStyle(fontSize: 14, color: AppColors.appBarForeground),
            ),
          ],
        ),
      ),
