...
import 'package:martfury/src/view/screen/help_center_screen.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    // App info section at the bottom
  ...
  Widget _buildLoadingState() {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          // Header skeleton (with its own shimmer for primary background)
          ...
          Expanded(
            child: Shimmer.fromColors(
              ...
              highlightColor: isDark
                  ? AppColors.darkSkeleton.withValues(alpha: 0.5)
                  : Colors.white,
              child: SingleChildScrollView(
