...
class _AddEditAddressScreenState extends State<AddEditAddressScreen> {
  ...
  Future<void> _loadCountries() async {
    try {
      ...
      // Remove duplicates and filter out placeholder
      final uniqueCountries = <String, Country>{};
      for (final country in countries) {
        // Skip empty placeholder country
        if (country.code?.isEmpty ?? true) continue;
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSectionHeader(
              ...
              title: 'address.personal_info'.tr(),
            ),
            const SizedBox(height: 16),
            _buildTextField(
            ...
            _buildSectionHeader(
              ...
              title: 'address.location_info'.tr(),
            ),
            const SizedBox(height: 16),
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  ...
                  AppColors.getBorderColor(context).withValues(alpha: 0.0),
                ],
              ),
            ),
          ),
